...
class GetPaymentsHistoryItemsRequest extends FormRequest implements FiltersInterface
{
    /**
    ...
    {
        return $this->input('order_by_field', config('pss_my_budget_config.filters.order_by_field'));
    }
    ...
    {
        return $this->has('date_from') ? Carbon::parse($this->input('date_from')) : null;
    }
    ...
    {
        return $this->has('date_to') ? Carbon::parse($this->input('date_to')) : null;
    }
}
